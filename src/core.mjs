// fact-gate core — verify LLM-generated text against a source of truth.
//
// This module and everything it imports use no Node built-ins, so the same
// code runs in a browser (see docs/playground). Node-only pieces (measured
// facts, the hook, trust) are re-exported from index.mjs.
//
